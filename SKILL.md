...
description: "Search X (Twitter) for posts matching keywords, hashtags, accounts, dates, engagement thresholds, media types, languages, and locations. Collect normalized post text, author details, engagement, media, source links, and pagination cursors for social listening, sentiment analysis, campaign tracking, competitor monitoring, and bulk research. Requires an active X browser session and browser-act network capture."
---
